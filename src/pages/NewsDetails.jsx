...
export default function NewsDetails() {
  ...
  const { favoritesState, favoritesDispatch } = useContext(FavoritexContext);
  ...
  return (
    <Layout>
      ...
      {showAlert && (
        <div
          className="alert alert-success fixed-top w-80 text-center container"
          role="alert"
        >
          Cartea a fost adaugata la favorite!
        </div>
      )}
    </Layout>
  );
